...
INSERT into sottoCategoria(idSottocat,nomeSott)
	...
	values	('pac001','Sviluppo','svi001',49.90,'C &egrave; un linguaggio utile per quasi tutti i programmatori di computer. Alla fine di questo corso, capirai i fondamenti del linguaggio di programmazione C e ti renderai pi&ugrave; commerciabile per le posizioni di programmazione entry level','Programmazione C per principianti','img/pacchetti/C1.png', true, '1'),
			('pac002','Sviluppo','svi001',65.00,'C ++ pu&ograve; essere difficile da imparare, ma farlo ha enormi profitti. Se sei interessato ad imparare come usare C ++ per lo sviluppo del gioco, o una pi&ugrave; ampia introduzione all argomento', 'Programmazione in C ++ Da principiante ad oltre','img/pacchetti/C++.png', true, '1'),
			('pac003','Sviluppo','svi001',79.99,'Java &egrave; uno dei linguaggi di programmazione pi&ugrave; popolari. Java offre funzioni di programmazione sia orientate agli oggetti che funzionali','Programmazione Java per principianti ','img/pacchetti/java1.png', true, '1'), 
			...
			('pac005','Sviluppo','svi002',169.99,'Stabilire le basi pi&ugrave; solide possibili nello sviluppo di database imparando a utilizzare MySQL, il database open source pi&ugrave; popolare al mondo : scrivere query, creare report a proprio piacimento, creare applicazioni Web, incorporare MySQL come livello di database - rendere i propri sogni di sviluppo una realt&agrave; seguendo questo corso e mettendo un segno di spunta accanto al tuo skillset di sviluppo in crescita.','Il corso completo per sviluppatori MySQL','img/pacchetti/mysql.png', true, '1'), 
			...
			('pac014','Informatica','inf002',119.90,'Dopo questo corso, sarete in grado di scoprire le vulnerabilit&agrave;&nbsp;della sicurezza su un intera rete, utilizzando tecniche di hacking della rete e scansione delle vulnerabilit&agrave;.','Corso completo sulla sicurezza','img/pacchetti/sicurezza.png', true, '1'), 
			...
			('pac017','Produttivita','pro001',70.00,'In questo imparerai come padroneggiare PowerPoint con semplici istruzioni passo passo. Questo corso comprende strumenti PowerPoint di base e avanzati. Con questi video tutorial facili da seguire, chiunque pu&Atilde;&sup2; imparare a creare presentazioni professionali. ','Corso di PowerPoint','img/pacchetti/powerpoint.png', true,'1'), 
			('pac018','Produttivita','pro001',65.00,'Al termine di questo corso avrai padroneggiato gli strumenti di Excel pi&ugrave; diffusi e ne uscirai con fiducia per completare qualsiasi attivit&agrave;&nbsp; di Excel con efficienza e grazia.','Microsoft Excel','img/pacchetti/excel.png', true,'1'), 
			...
			('pac022','Design','des001',120.5,'Master Photoshop CC 2019 senza alcuna conoscenza precedente con questo corso facile da seguire','Corso di Photoshop','img/pacchetti/photoshop.png', true,'1'), 
			('pac023','Design','des001',150.5,'Scopri il design grafico di Adobe Illustrator CC, il design del logo e altro ancora con questo corso approfondito, pratico e facile da seguire!','Adobe Illustrator CC','img/pacchetti/adobe-i.png', true,'1'), 
			('pac024','Design','des001',179.99,'Creare newsletter aziendali, brochure, relazioni annuali. Impara tipografia, teoria dei colori e abilit&agrave;&nbsp;di progettazione grafica in InDesign','Adobe InDesign CC ','img/pacchetti/adobeind.png', true,'1'), 
			...
			('pac027','Design','des003',60.00,'Un corso completo per l apprendimento di AutoCAD da zero a livello professionale','Il corso completo di AutoCAD','img/pacchetti/autocad.png', true,'1'), 
			('pac028','Design','des004',194.99,'Usa Blender per creare bellissimi modelli 3D per videogiochi, stampa 3D, design di case, ecc. Nessuna conoscenza richiesta.','Blender Creator','img/pacchetti/blender.png', true,'1'), 
			...
			('pac030','Musica','mus001',99.99,'Il sistema di canto passo dopo passo ha dimostrato di sviluppare grande tecnica e maestria vocale, i risultati sono immediati!','Corso di canto','img/pacchetti/canto.png', true,'1'), 
			('pac031','Musica','mus002',99.99,'Corso di chitarra all-in-one con un comprovato sistema di apprendimento passo-passo.','Corso di chitarra','img/pacchetti/chitarra.png', true,'1'), 
			...
			('pac033','Musica','mus002',139.99,'Corso di violino per principianti - Start Violin from Scratch - Il corso di violino per principianti pi&ugrave; approfondito disponibile online.','Corso per violino','img/pacchetti/violino.png', true,'1'), 
			('pac034','Musica','mus003',180.00,'Unisciti alla produzione musicale di successo + Gli studenti di Logic Pro X nella creazione, registrazione, mixaggio di musica e mastering in Logic Pro X','Logic Pro X','img/pacchetti/logicprox.png', true,'1'), 
			('pac035','Musica','mus003',50.00,'Master Avid Pro Tools 11. Scopri i segreti di produzione audio utilizzati dai professionisti. Un tutorial di Pro Tools facile da seguire.','Master Pro Tools 11','img/pacchetti/protools.png', true,'1'), 
			('pac036','Musica','mus004',70.00,'Un approccio approfondito e diretto per comprendere la musica.','Teoria musicale','img/pacchetti/teoriamusicale.png', true,'1'), 
			('pac037','Fotografia','fot001',140.00,'In questo corso completo gli studenti impareranno come modificare i loro video utilizzando Final Cut Pro X da principiante a intermedio','Final Cut Pro X','img/pacchetti/finalcutprox.png', true,'1'), 
			('pac038','Fotografia','fot001',170.00,'Se stai cercando un applicazione di editing video che ti consenta di modificare i video come preferisci, Adobe Premiere Pro &egrave; la migliore risposta. Premiere Pro &egrave; utilizzato per ogni tipo di produzione da video aziendali e di marketing, video musicali a documentari, lungometraggi.','Adobe Premiere Pro CS6','img/pacchetti/adobepremiere.png', true,'1'), 
			('pac039','Fotografia','fot002',49.99,'Scopri come utilizzare la videocamera in modo intuitivo. Impara facendo piuttosto che memorizzando.','Fotografia principiante','img/pacchetti/fotoprincipiante.png', true,'1'), 
			('pac040','Fotografia','fot002',99.99,'Scatti meravigliose foto notturne che impressionano la tua famiglia e i tuoi amici con questo corso completo di fotografia notturna!','Fotografia notturna','img/pacchetti/fotografare-notte.png', true,'1'), 
			('pac041','Fotografia','fot003',49.99,'Con la fotografia di base , puoi imparare rapidamente a scattare meravigliose foto di cibo anche se non hai mai preso una macchina fotografica e non hai mai disegnato un piatto di cibo!','Fotografia dell alimento','img/pacchetti/fotografarecibo.png', true,'1'), 
			('pac042','Fotografia','fot003',189.99,'Impara esattamente come diventare un fotografo di matrimoni, avviare un attivit&agrave; fotografica per conto tuo e scattare foto di nozze migliori.','Fotografia di matrimoni','img/pacchetti/fotografare-matrimonio.png', true,'1'), 
			('pac043','Insegnamento','ins001',30.00,'Primo corso in Algebra (inizio algebra).','Algebra I (Algebra iniziale)','img/pacchetti/algebra.png', true,'1'), 
			('pac044','Insegnamento','ins001',79.99,'Pi&ugrave; di 60 domande risolte per aiutarvi ad entrare nel flusso di problemi statistici di cracking (Binomiale, Distribuzione Normale ecc.)','Esercitazione su statistiche','img/pacchetti/matematica.png', true,'1'), 
			('pac045','Insegnamento','ins001',98.99,'Master Discrete Math, la spina dorsale di Matematica e Informatica','Corso matematica discreta','img/pacchetti/discreta.png', true,'1'), 
			('pac046','Insegnamento','ins002',199.99,'Impara l inglese per principianti (A1-&gt; A2+) ','Corso di inglese','img/pacchetti/inglese.png', true,'1'), 
			('pac047','Insegnamento','ins002',199.99,'Corso di spagnolo per principianti - Impara la lingua spagnola ','Corso di spagnolo','img/pacchetti/corsospagnolo.png', true,'1'), 
			('pac048','Business','bus001', 164.99,'Scopri come utilizzare l analisi aziendale per consigliare la soluzione migliore e cambiare strategia per raggiungere gli obiettivi della tua organizzazione ' ,'Analisi Aziendale : analisi strategica','img/pacchetti/analisiaziendale.png', true,'1'), 
			('pac049','Business','bus001',149.99,'Strategia aziendale: capire cosa serve per avere successo negli affari','Business Fundamentals: strategia aziendale','img/pacchetti/strategiabuisiness.png', true,'1'), 
			('pac050','Business','bus002',174.99,'La guida AZ per far crescere il tuo seguito su Instagram, massimizzare il tuo coinvolgimento e aumentare lead e vendite.','Il corso completo di marketing su Instagram','img/pacchetti/marketingstrategia.png', true,'1'), 
			('pac051','Business','bus002',199.99,'Domina la pubblicit&agrave;&nbsp;su Facebook e fai crescere qualsiasi attivit&agrave; commerciale: strategia di marketing su Facebook, retargeting degli annunci, remarketing e altro ancora!','Il corso completo di annunci di Facebook','img/pacchetti/facebook.png', true,'0');
